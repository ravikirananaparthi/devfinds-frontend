...
const socket = io("https://devfinds-backend.onrender.com/api/v1/", {
  reconnection: true,
});
...
const PostDetail = () => {
  ...
  return (
    <div data-theme="dark" className="flex items-center justify-center min-h-screen bg-gray-100 ">
      <div className="max-w-3xl w-full p-8 bg-white rounded-2xl shadow-lg">
        ...
        {post.tof === "pic" && post.image && (
          <img
            src={post.image}
            alt="Post Image"
            className="mb-4 rounded-lg shadow-lg object-cover w-full h-auto cursor-pointer"
